...
class AppListViewModel @Inject constructor(
    ...
    var period by mutableStateOf(UsagePeriod.DAY)
        private set
...
fun AppListScreen(viewModel: AppListViewModel = hiltViewModel()) {
    ...
    selectedApp?.let { app ->
        AlertDialog(
            ...
            text = {
                Column {
                    DetailRow(stringResource(R.string.apps_detail_wifi), ByteFormatter.format(app.wifiBytes))
                    DetailRow(stringResource(R.string.apps_detail_mobile), ByteFormatter.format(app.mobileBytes))
                    DetailRow(stringResource(R.string.apps_detail_total), ByteFormatter.format(app.totalBytes))
                }
            },
            confirmButton = {
